...
const ResultURL =
  "https://activity-1.m.duiba.com.cn/signpet/getPetsInfo?activityId=27";
...
function Get() {
  if (
    ...
    $request &&
    $request.method == "POST" &&
    $request.url.indexOf("getSignInfo") >= 0
  ) {
    ...
    $cmp.notify(
      "写入" + TokenName + " Token 及 " + CookieName + " Cookie 失败‼️",
      "",
      "配置错误, 无法读取请求头, "
    );
  }
  ...
  return new Promise((resolve) => {
    let HiCheckin = {
      ...
      headers: {
        ...
        Referer:
          "https://activity-1.m.duiba.com.cn/signpet/index?activityId=27&from=login&spm=47663.1.1.1",
      },
      ...
      try {
        if (error) {
          ...
          if (obj3.success == true && obj3.signInfoVO.todaySigned == true) {
            ...
            obj3.success == false &&
            obj3.signInfoVO.todaySigned == true
          ) {
            datainfo.success = 2;
            datainfo.days = obj3.signInfoVO.continueDay;
          } else {
...
function notify() {
  return new Promise((resolve) => {
    try {
      const sub =
        "尊敬的" + datainfo.level + "，您共有 " + datainfo.coin + " 捞币。";
...
function compatibility() {
  const e = "undefined" != typeof $request,
    ...
    i = (e, s, i) => {
      r && $notify(e, s, i),
        t && $notification.post(e, s, i),
        o && a(e + s + i),
        n && $push.schedule({ title: e, body: s ? s + "\n" + i : i });
    },
    u = (e, n) =>
      r
        ...
        : void 0,
    d = (e) =>
      r ? $prefs.valueForKey(e) : t ? $persistentStore.read(e) : void 0,
    l = (e) => (
      e &&
        (e.status
    ...
    f = (e, i) => {
      r &&
        ...
        $task.fetch(e).then(
          ...
          (e) => i(e.error, null, null)
        )),
        t &&
          $httpClient.get(e, (e, t, r) => {
            i(e, l(t), r);
          }),
        o &&
          s.request(e, (e, t, r) => {
        ...
        n &&
          ...
          (e.handler = function (e) {
            ...
            let r = e.data;
            "object" == typeof r && (r = JSON.stringify(e.data)),
              i(t, l(e.response), r);
          }),
          $http.get(e));
    },
    p = (e, i) => {
      r &&
        ...
        t &&
          $httpClient.post(e, (e, t, r) => {
            i(e, l(t), r);
          }),
        o &&
          s.request.post(e, (e, t, r) => {
            i(e, l(t), r);
          }),
        n &&
          ("string" == typeof e && (e = { url: e }),
