...
const option = {
  "open-url":
    "yocial://webview/?url=https%3A%2F%2F2do.jd.com%2Fevents%2F7-days%2F%23%2F&login=1",
};
const option2 = {
  "open-url":
    "yocial://webview/?url=https%3A%2F%2Flwxianshi.jd.com%2FidleHours%2Findex.html%23%2Fwallet&login=1",
};
...
const header = {
  ...
  "User-Agent":
    "Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148/yocial,",
};
...
const header2 = {
  ...
  Host: "api.m.jd.com",
  Origin: "https://2do.jd.com",
  Referer: "https://2do.jd.com/app/my-assets/",
  "User-Agent":
    "Mozilla/5.0 (iPhone; CPU iPhone OS 14_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148/yocial/5.2.3(iOS;14.2;com.jd.campustodo)",
};
...
var moneyparams = {
  ...
  headers: header2,
  body:
    `appid=yocial-h5&functionId=v1_myProperty_loadCenterInfo&t=` +
    nowtime +
    `&loginType=2`,
};
...
function getmoney() {
  return new Promise((resolve) => {
    sams.post(moneyparams, (error, reponse, data) => {
      try {
...
function sign() {
  return new Promise((resolve) => {
    sams.post(params, (error, reponse, data) => {
      try {
...
function resetSign() {
  return new Promise((resolve) => {
    sams.post(resetparams, (error, reponse, data) => {
      try {
        result = JSON.parse(data);
        sams.log(result);
        if (result.status == true) {
...
function show() {
  let title = "梨涡签到领现金";
  sams.msg(title, usermsg, money + message, {
    "open-url":
      "yocial://webview/?url=https%3A%2F%2F2do.jd.com%2Fevents%2F7-days%2F%23%2F&login=1",
    "media-url": userimg,
  });
